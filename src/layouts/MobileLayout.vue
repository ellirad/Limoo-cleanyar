<template>
  <div style="position: relative;">
    ...
    <!-------------------------------- Footer ---------------------------------->
    <footer-mobile v-if="isAuthenticated && currentRoute !== 'login'" />
  </div>
</template>

<script>
import FooterMobile from "../view/mobile/Footer-mobile.vue";
import HeaderMobile from "../view/mobile/Header-mobile.vue";
import { mapGetters } from "vuex";

export default {
  components: { HeaderMobile, FooterMobile },
  data() {
    return {
      drawer: null,
